      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-16">
        ...
        <div className="grid w-full max-w-4xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <button
            ...
            className="group fade-in-up rounded-xl border border-border bg-card p-8 text-left shadow-sm transition-all duration-300 hover:border-primary/40 hover:shadow-md card-animate"
          ...
          <button
            ...
            onMouseLeave={() => setHoveredRole(null)}
            className="group fade-in-up rounded-xl border border-border bg-card p-8 text-left shadow-sm transition-all duration-300 hover:border-primary/40 hover:shadow-md sm:col-span-2 lg:col-span-1 card-animate"
